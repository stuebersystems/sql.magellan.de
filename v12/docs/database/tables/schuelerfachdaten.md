...
Diese Tabelle hat 29 Fremdschlüssel.
...
**`FK_SCHUELERFACHDATEN_ENDNOTEVORZ`**

:   `EndnoteVorzeitraum, Mandant` » [`Noten (ID, Mandant)`](../../tables/noten) · `ON UPDATE RESTRICT` · `ON DELETE RESTRICT`

## Indizes

Diese Tabelle hat 30 Indizes.
