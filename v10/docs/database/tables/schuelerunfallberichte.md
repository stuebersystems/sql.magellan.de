...
:   [`DATE`](https://firebirdsql.org/file/documentation/html/en/refdocs/fblangref40/firebird-40-language-reference.html#fblangref40-datatypes-datetime)
    ...
    Wenn `UnterbrechungBesuch` = S, dann ist hier das Datum eingetragen

**`UnterbrechungBesuchStunde`**

:   [`SMALLINT`](https://firebirdsql.org/file/documentation/html/en/refdocs/fblangref40/firebird-40-language-reference.html#fblangref40-datatypes-inttypes)

    Wenn `UnterbrechungBesuch` = S, dann ist hier die Stunde eingetragen
...
:   [`DATE`](https://firebirdsql.org/file/documentation/html/en/refdocs/fblangref40/firebird-40-language-reference.html#fblangref40-datatypes-datetime)
    ...
    Wenn `WiederaufnahmeBesuch` = J, dann ist hier das Datum eingetragen
...
:   [`BLOB subtype text`](https://firebirdsql.org/file/documentation/html/en/refdocs/fblangref40/firebird-40-language-reference.html#fblangref40-datatypes-bnrytypes)
    ...
    Name behandelnder Arzt\/Krankenhaus
