...
??? info "SQL"
    ...
    SELECT                                                                   
      ...
      K."Berufsfeld",                                                      
      K."Einzelintegration",                                               
      K."Laenderuebergreifend",                                            
      K."Schulartuebergreifend",                                           
      K."MerkmalA1",                                                       
      K."MerkmalA2",                                                       
      K."MerkmalA3",                                                       
      K."MerkmalA4",                                                       
      ...
      KZ."Klassensprecher1",                                               
      KZ."Klassensprecher2",                                               
      KZ."Klassenwahlvertreter1",                                          
      KZ."Klassenwahlvertreter2",                                          
      KZ."Klassenelternsprecher1",                                         
      KZ."Klassenelternsprecher2"
    FROM "Klassen" K 
    LEFT JOIN "KlassenZeitraeume" KZ                                                 
    ON  KZ."Mandant" = K."Mandant" 
    AND KZ."Klasse" = K.ID
    ```
