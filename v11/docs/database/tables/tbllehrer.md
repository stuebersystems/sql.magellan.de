...
Diese Tabelle hat 52 Fremdschlüssel.
...
:   `Beschaeftigungsverh` » [`Beschaeftigungsverh (Kuerzel)`](../../tables/beschaeftigungsverh) · `ON UPDATE CASCADE` · `ON DELETE RESTRICT`
...
:   `Dienstverh` » [`Dienstverh (Kuerzel)`](../../tables/dienstverh) · `ON UPDATE CASCADE` · `ON DELETE RESTRICT`
